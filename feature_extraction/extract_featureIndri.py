...
pathIndriParam = "/projets/iris/PROJETS/PRINCESS/code/param/configIndri_" + collection_name + ".param"

pathIndriParamOkapi = "/projets/iris/PROJETS/PRINCESS/code/param/configIndriOkapi_" + collection_name + ".param"
pathIndriParamTfidf = "/projets/iris/PROJETS/PRINCESS/code/param/configIndriTfidf_" + collection_name + ".param"
pathIndriParamIndri = "/projets/iris/PROJETS/PRINCESS/code/param/configIndrimodel_" + collection_name + ".param"
pathTempFilteredFile = "/projets/iris/PROJETS/PRINCESS/code/temp/filteredIndri_" + collection_name + ".txt"
pathTempFile = "/projets/iris/PROJETS/PRINCESS/code/temp/fileIndri_" + collection_name + ".txt"

resultModelOkapi = "/projets/iris/PROJETS/PRINCESS/code/temp/resultIndriModelOkapi_" + collection_name + ".txt"
resultModelTfidf = "/projets/iris/PROJETS/PRINCESS/code/temp/resultIndriModelTfidf_" + collection_name + ".txt"
resultModelIndri = "/projets/iris/PROJETS/PRINCESS/code/temp/resultIndriModelIndri_" + collection_name + ".txt"
...
for currIndex in indexValues.keys() :  # Pour chaque type d'index
    ...
    for q in queryTerms.keys() :  # Pour chaque requete
        ...
        dumpIndexT = "/projets/iris/PROJETS/PRINCESS/code/temp/dumpIndexT_" + normType + maxRes + ".txt"
                                        ...
                                        if infoFeatures[i]["index"] ==  currIndex and infoFeatures[i]["dependant"] == "document" and isFirstTerm:
                                            ...
                                            if feat in functionMapping:
                                                if feat == "f52": 
                                                    ...
                                                    print currDoc
                                                    dumpIndexT = "/projets/iris/PROJETS/PRINCESS/code/temp/dumpIndexT_" + normType + maxRes
